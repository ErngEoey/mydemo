              ...
              <fieldset>
                <form>
                  ...
                  <div className="form-group">
                    <div className="row">
                      <div className="col">
                        ...
                        <input type="text" className={`form-control ${errors.fname ? 'is-invalid' : ''}`} placeholder="First name" aria-label="First name" {...register('fname', { required: true })} />
                      </div>
                      <div className="col">
                        <label htmlFor="lastname" className="form-label">Last name</label>
                        <input type="text" className={`form-control ${errors.lname ? 'is-invalid' : ''}`} placeholder="Last name" aria-label="Last name" {...register('lname', { required: true })} />
                      </div>
                    </div>
                  </div>
                  <div className="form-group">
                    <label htmlFor="username" className="form-label">Username</label>
                    <input type="text" className={`form-control ${(errors.username || usernameUsed) && 'is-invalid'}`} id="username" placeholder="username" {...register('username',
                      {
                  ...
                  <div className="form-group">
                    ...
                    <input type="email" className={`form-control ${(errors.email || emailUsed) ? 'is-invalid' : ''}`} id="email" placeholder="name@example.com" {...register('email',
                      {
                        required: { value: true },
                  ...
                  <div className="form-group">
                    ...
                    <input type="password" className={`form-control ${errors.password ? 'is-invalid' : ''}`} id="password" placeholder="********" {...register('password',
                      {
                        required: true,
                  ...
                  <div className="form-group">
                    ...
                    <input type="password" className={`form-control ${errors.confirmPass ? 'is-invalid' : ''}`} id="cf-password" placeholder="********" {...register('confirmPass',
                      {
                        required: true,
